...
<li class="dropdown">
    ...
    <div class="dropdown-content">
        <a href="create_seller.php"><i class="fas fa-user"></i>  Create seller</a>
        <a href="seller_list.php"><i class="fas fa-history"></i>  Seller list</a>
    </div>
</li>
...
<li class="dropdown">
    ...
    <div class="dropdown-content">
        <a href="create_client.php"><i class="fas fa-plus"></i>  Create client</a>
        <a href="client_list.php"><i class="fas fa-list-ol"></i>  Client list</a>
    </div>
</li>
<li class="dropdown">
    <a href="javascript:void(0)" class="dropbtn"><i class="fas fa-user-circle"></i>  Orders</a>
    <div class="dropdown-content">
        <a href="orders.php"><i class="fas fa-wrench"></i>  In progress</a>
        <a href="orders.php?history"><i class="fas fa-history"></i>  History</a>
    </div>
</li>
<?php } ?>
...
<li class="dropdown">
    ...
    <div class="dropdown-content">
        ...
        <a href="edit_profile.php"><i class="fas fa-pencil-alt"></i>  Edit profile</a>
