        ...
        <div class="context" id="context">
            ...
            <div class="in_progress" id="in_progress" align = "center">
                <div style = "width:500px; border: solid 1px #333333; margin: 25px; " align = "center">
                    <div style = "background-color:#333333; color:#FFFFFF; padding:3px;"><b>History</b></div>
                    <div style = "margin:30px">
                        <?php
                            include 'database/DB_Engine.php';
                            $rez = fetchRows("SELECT distinct(order_id), user_id FROM orders WHERE confirmed = 1");
                        ?>
                        ...
                        <form action = "" method = "post">
                            <div class="row">
                                ...
                                <div class="column" style="margin-top: 70px;">
                                    <input type = "submit" id="confirm_order"    value = " Print "    style="display: block; width: 100px;"/><br/>
                                </div>
                            </div>
                        </form>
                        <hr>
