...
INSERT INTO `articles` VALUES (4,'Trousers',20,'Blue trousers for adults',1),(5,'Shirt',4,'small red shirt',1),(6,'aa',10,'aa',NULL);
...
INSERT INTO `orders` VALUES ('5b1569bafae59787bc6e68bd21b072f2',13,4,2,'canceled'),('5b1569bafae59787bc6e68bd21b072f2',13,5,1,'canceled');
...
CREATE TABLE `users` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=16 DEFAULT CHARSET=utf8 COLLATE=utf8_slovenian_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `users` VALUES (6,'Elon','Muska','','','','','','admin@admin.si','f212bd60369e4bf2b09320cab3d2e8b14e13a3a5006ab20e0a39858d560a27ee',1,'1'),(10,'Anka','Drobec',NULL,NULL,NULL,NULL,NULL,'anka@anka.si','e7ad0e1dca8770bf779c587f057e5b9422de6b37be7cd06f4e67b2135614928c',2,'1'),(13,'Miha','Tanko','Zalozniška 20','Ljubljana','1000','Srbija','031 553 395','miha@miha.si','3bacc4834997402c65911087fc29085c92f15918c3415664760c3461629c743c',3,'1');
...
-- Dump completed on 2018-02-06 14:12:20
